...
export class NavComponent implements OnInit {
  ...
  tabelaEscalonada: TabelaEscalonada[] = [
    { faixa: 5, fatormultiplicador: 3.17 },
    { faixa: 10, fatormultiplicador: 6.76 },
    { faixa: 15, fatormultiplicador: 10.48 },
    { faixa: 20, fatormultiplicador: 14.31 },
    { faixa: 40, fatormultiplicador: 18.20 },
    { faixa: 40, fatormultiplicador: 22.20 }
  ]
  ...
  calculaCOPASA(consumoDaUnidade):number 
  {
    ...
    if (consumoDaUnidade > 5) 
    {
      valorUnidade += 5 * this.tabelaEscalonada[4].fatormultiplicador;
      consumoDaUnidade = consumoDaUnidade -5;        
    }
    else
    {
